// ============================================================
// NOTIFICATIONS PAGE - Admin Main (TO'LIQ)
// ============================================================
...
function renderNotifications(notifications) {
    ...
    // ⭐ Admin-Main ekanligini tekshirish
    const user = Auth.getUser();
    ...
    Object.keys(grouped).forEach(dateKey => {
        ...
        grouped[dateKey].forEach(notif => {
            ...
            const recipientName = notif.recipientName || 'Barcha adminlar';
                ...
                <div class="notification-item ${isUnread ? 'unread' : ''}">
                    <div class="notification-body">
                        ...
                        <div class="notification-meta">
                            ...
                            <span><i class="fas fa-user-check"></i> 📬 Qabul qiluvchi: ${recipientName}</span>
                    ...
                    <div class="notification-actions">
                        ${!isAdminMain && isUnread ? `
                            <button class="btn-read" data-id="${notif._id}">
                                <i class="fas fa-check"></i> O'qildi
                            </button>
                        ` : ''}
                        ${isAdminMain ? `
                            <button class="btn-delete" data-id="${notif._id}">
                                <i class="fas fa-trash"></i> O'chirish
                            </button>
                        ` : ''}
                        ${isUnread && isAdminMain ? `
                            <span class="read-label">⏳ O'qilmagan</span>
                        ` : ''}
                        ${notif.isRead ? `
...
async function markAllAsRead() {
    try {
        ...
        const response = await fetch('https://admin-main-backend.onrender.com/api/notifications/mark-all-read', {
            method: 'POST',
            headers: {
...
console.log('✅ notifications-page.js yuklandi');
